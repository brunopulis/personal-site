...
export default async function (eleventyConfig) {
  ...
  eleventyConfig.addFilter('mediaCategories', filters.mediaCategories);
  eleventyConfig.addFilter('categoriesSlugs', filters.categoriesSlugs);
  ...
  eleventyConfig.addFilter('featuredPosts', items => filters.featuredPosts(items));
  eleventyConfig.addFilter('nonFeaturedPosts', items => filters.nonFeaturedPosts(items));
