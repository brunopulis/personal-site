...
import {getAllPosts, getAllBooks, getAllNotes, getAllPoems, showInSitemap, tagList} from './src/_config/collections.js';
...
export default async function(eleventyConfig) {
  ...
  eleventyConfig.addCollection('poems', getAllPoems);
