...
- **Espaçamento:** O [deslocamento do alvo](https://www-w3-org.translate.goog/WAI/WCAG22/Understanding/target-size-minimum.html?_x_tr_sl=auto&_x_tr_tl=pt&_x_tr_hl=pt-BR&_x_tr_pto=wapp#dfn-target-offset) é de pelo menos 24x24 pixels para cada alvo adjacente;
...
A princípio, podemos usar técnicas básicas para cumprir esse critério. O recomendável é utilizar um espaçamento entre os elementos seja **24x24 pixels**.

Não necessariamente o elemento deve ter 24x24 pixels, mas a soma do alvo tenha esse tamanho.
