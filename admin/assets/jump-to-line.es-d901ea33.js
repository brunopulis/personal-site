import { c as d, h as g } from './codemirror.es2-5884f31a.js';
import { k as h } from './dialog.es2-02b3b4e7.js';
var b = Object.defineProperty,
  p = (c, l) => b(c, 'name', { value: l, configurable: !0 });
function f(c, l) {
    ...
    if (typeof s != 'string' && !Array.isArray(s)) {
      for (const i in s)
        if (i !== 'default' && !(i in c)) {
          ...
          a && Object.defineProperty(c, i, a.get ? a : { enumerable: !0, get: () => s[i] });
        }
    }
  }
  return Object.freeze(Object.defineProperty(c, Symbol.toStringTag, { value: 'Module' }));
}
p(f, '_mergeNamespaces');
var y = { exports: {} };
(function (c, l) {
  (function (o) {
    o(d(), h());
    ...
    function s(e, r, n, t, u) {
      e.openDialog
        ? e.openDialog(r, u, { value: t, selectValueOnOpen: !0, bottom: e.options.search.bottom })
        : u(prompt(n, t));
    }
    p(s, 'dialog');
    function i(e) {
    ...
    (p(a, 'interpretLine'),
      (o.commands.jumpToLine = function (e) {
        var r = e.getCursor();
        s(e, i(e), e.phrase('Jump to line:'), r.line + 1 + ':' + r.ch, function (n) {
          if (n) {
            ...
            if ((t = /^\s*([\+\-]?\d+)\s*\:\s*(\d+)\s*$/.exec(n)))
              ...
              var u = Math.round((e.lineCount() * Number(t[1])) / 100);
              (/^[-+]/.test(t[1]) && (u = r.line + u + 1), e.setCursor(u - 1, r.ch));
...
var m = y.exports;
const v = g(m),
  x = f({ __proto__: null, default: v }, [m]);
export { x as j };
