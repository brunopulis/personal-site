...
`
          ...
          function Wa(t, e) {
            var r = jr(t, e);
            (r.scrollTop != null && Ze(t, r.scrollTop),
              r.scrollLeft != null && oe(t, r.scrollLeft));
          }
          u(Wa, 'scrollIntoView');
          function jr(t, e) {
            var r = t.display,
          ...
          function xo(t) {
            (t.display.scrollbars &&
              ...
              t.display.scrollbars.addClass &&
                Zt(t.display.wrapper, t.display.scrollbars.addClass));
          }
          u(xo, 'initScrollbars');
          var ru = 0;
          function le(t) {
                    ...
                    setTimeout(function () {
                      if (l.wheelStartX != null) {
                        var y = a.scrollLeft - l.wheelStartX,
                          ...
                          x =
                            (b && l.wheelDY && b / l.wheelDY) || (y && l.wheelDX && y / l.wheelDX);
          ...
          function ni(t, e, r, n) {
            ...
            if (e.full) (t.insert(0, l(0, c.length)), t.remove(c.length, t.size - c.length));
              ...
              (o(h, h.text.slice(0, a.ch) + c[0] + d.text.slice(s.ch), i(0)),
                t.remove(a.line + 1, g));
            else {
          ...
          ((ct.prototype = yi(on.prototype, {
            ...
            addSelection: Y(function (t, e, r) {
              ...
              (n.push(new H(O(this, t), O(this, e || t))),
                tt(this, Lt(this.cm, n, n.length - 1), r));
            }),
            ...
            getAllMarks: function () {
              ...
              return (
                this.iter(function (e) {
                  var r = e.markedSpans;
                  if (r)
                    for (var n = 0; n < r.length; ++n) r[n].from != null && t.push(r[n].marker);
                }),
                t
              );
            },
            ...
            linkedDoc: function (t) {
              ...
              (t.from != null && t.from > e && (e = t.from),
                t.to != null && t.to < r && (r = t.to));
              var n = new ct(
                yr(this, e, r),
            ...
            (u(l, 'farAway'),
              ...
              M(e.scroller, 'scroll', function () {
                e.scroller.clientHeight &&
                  (Ze(t, e.scroller.scrollTop),
                  oe(t, e.scroller.scrollLeft, !0),
                  U(t, 'scroll', t));
              }),
              ...
              moveV: nt(function (n, i) {
                ...
                if (
                  (l.extendSelectionsBy(function (h) {
                    ...
                    var p = Ll(o, d, n, i);
                    return (
                      i == 'page' && h == l.sel.primary() && Xr(o, Dn(o, p, 'div').top - d.top),
                      p
                    );
                  }, pn),
                  a.length)
