import { C as s } from './codemirror.es-52e8b92d.js';
import { o, u as e, v as l, w as n, x as r } from './index-8b22ee97.js';
import { r as c } from './mode-indent.es-057a4f6a.js';
import './codemirror.es2-5884f31a.js';
var b = Object.defineProperty,
  d = (a, t) => b(a, 'name', { value: t, configurable: !0 });
s.defineMode('graphql-variables', (a) => {
  const t = o({
...
const m = {
  ...
  V = {
    ...
    ObjectField: [i('attribute'), e(':'), 'Value'],
  };
function i(a) {
  return {
    style: a,
