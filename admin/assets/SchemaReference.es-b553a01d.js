...
import { f as te, h as bt, i as Ot, e as St, k as At, l as Lt } from './index-8b22ee97.js';
    ...
    Z(t, (n, i) => {
      ...
      (M(n) || I(!1, `${e.name}.${i} field config must be an object.`),
        n.resolve == null ||
          ...
          I(
            !1,
            `${e.name}.${i} field resolver must be a function if provided, but got: ${N(n.resolve)}.`
          ));
    ...
    Object.entries(t).map(
      ([n, i]) => (
        M(i) ||
          I(
            !1,
            `${e}.${n} must refer to an object with a "value" key representing an internal value but got: ${N(i)}.`
          ),
        {
          name: ut(n),
  ...
  $t = new B({
    ...
    parseLiteral(e) {
      if (e.kind !== y.STRING && e.kind !== y.INT)
        throw new T('ID cannot represent a non-string and non-integer value: ' + V(e), {
          nodes: e,
        });
      return e.value;
    },
