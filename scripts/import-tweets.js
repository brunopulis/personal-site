...
const CONFIG = {
  // Caminho para o arquivo de tweets do Twitter Archive
  twitterDataPath: './scripts/tweets/data/tweets.js',
  tweetsOutputPath: './src/content/notes',
...
async function importTweets() {
  console.log('🐦 Importador de Tweets para Astro\n');
  ...
  console.log(`\n💡 Próximos passos:`);
  console.log(`   1. Configure a collection 'notes' no astro.config.mjs`);
  console.log(`   2. Execute 'npm run dev' para testar`);
  console.log(`   3. Crie páginas para listar suas notes`);
}
