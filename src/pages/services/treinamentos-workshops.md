...
permalink: "/services/treinamentos-workshops/index.html"
url: /services/treinamentos-workshops/

service:
  color: yellow-600
  tagline: Capacidade e confiança. Sua equipe saindo do workshop implementando.
  icon: 🎓

  problem: |
    Sua equipe quer fazer acessibilidade, mas falta conhecimento prático. 
    Tutoriais genéricos não resolvem os problemas específicos do seu produto e stack.
