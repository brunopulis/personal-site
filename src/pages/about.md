...
Foi aí que entendi algo simples, mas fácil de ignorar: **tecnologia boa é que inclui pessoas**.
...
Minha jornada não começou no código. Em 2010, formado em **Sistemas para Internet**, passei a
viver a web no dia a dia.

Trabalhei em agências, startups e projetos de diferentes tamanhos. Aprendi muito — e também vi muita gente
ficando de fora.

Alguns projetos que tenho orgulho de ter feito:

- [Awesome A11y](https://github.com/brunopulis/awesome-a11y-br)
- [Awesome Cypress](https://github.com/brunopulis/awesome-cypress)
- [Siglas Corporativas](https://siglas-corporativas.vercel.app/)
- [XPath vs CSS Selectors](https://github.com/brunopulis/v0-xp-ath-vs-css-selectors)
