...
export const siteDescription = 'Sou engenheiro de software focado em experiências inclusivas.';
...
export const author = {
  name: 'Bruno Pulis',
  avatar: '/icon/Sou engenheiro de software focado em experiências inclusivas.',
  ...
  opengraph_default_alt: 'Bruno Pulis - Engenheiro de Software'
};
