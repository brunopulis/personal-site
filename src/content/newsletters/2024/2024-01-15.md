...
![Imagem gerada com o Bing Create, prompt: teste automatizado.](/assets/images/newsletters/code.webp) _Imagem gerada com o Bing Create, prompt: teste automatizado._
...
## O teste de acessibilidade automatizado substitui o teste manual?
...
![Demonstração sem texto alterrnativo](/assets/images/newsletters/axe-linter.webp)
...
O resultado da asserção seria um erro indicando a ausência do atributo alt.
