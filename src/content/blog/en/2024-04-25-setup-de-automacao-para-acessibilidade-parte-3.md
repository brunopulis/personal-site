---
title: "[EN] Setup de automação para acessibilidade parte 3"
publishDate:
  - "2024-04-25T00:59:32.365Z"
draft:
  - "false"
isFeatured:
  - "false"
category:
  - "blog"
canonicalUrl: "https://medium.com/@brunopulis/setup-de-automa%C3%A7%C3%A3o-para-acessibilidade-parte-3-b7e16701dcab"
---

> **Translation Note**: This is a placeholder for the English translation of the Portuguese article.
> Original article: [Setup de automação para acessibilidade parte 3](https://medium.com/@brunopulis/setup-de-automa%C3%A7%C3%A3o-para-acessibilidade-parte-3-b7e16701dcab)
...
![Dashboard do Cypress](https://cdn-images-1.medium.com/max/800/0*KlxX0jHGERlIcVsR.png)
...
```
describe('Accessibility Tests', () =>   beforeEach(() =>     cy.visit('https://prefeitura.pbh.gov.br/');  );  it('Should pass accessibility tests', () =>     cy.injectAxe(); // Inject axe-core into the page    // Run accessibility tests on the page    cy.checkA11y();  ););
```
...
![](https://cdn-images-1.medium.com/max/800/0*F_STW0Xp3weLQnjP.png)
...
[**Newsletter - Bruno Pulis**  
_Acompanhe as edições anteriores da Pulis Letters_brunopulis.com](https://brunopulis.com/letters/setup-de-automacao-para-acessibilidade-parte-3/ "https://brunopulis.com/letters/setup-de-automacao-para-acessibilidade-parte-3/")[](https://brunopulis.com/letters/setup-de-automacao-para-acessibilidade-parte-3/)