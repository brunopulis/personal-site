---
title: "[EN] Texto alternativo: o guia definitivo"
excerpt: "[EN] Esta publicação contém tudo o que você precisa saber sobre texto alternativo! Quando usá-los e como desenhá-los perfeitamente. Por mim…"
publishDate:
  - "2017-10-26T12:47:26.632Z"
draft:
  - "false"
isFeatured:
  - "false"
...
> Original article: [Texto alternativo: o guia definitivo](https://medium.com/@brunopulis/texto-alternativo-o-guia-definitivo-ae196e7a1e39)
...
-   “cropped\_img32\_900px.png” ou “1521591232.jpg” — o nome dos arquivos, provalvelmente porque a imagem não tem o atributo alt definido.
-   “<Article title>” — em todas as imagens do artigo, provavelmente para melhorar o ranking de busca (SEO).
...
Um texto alternativo e uma descrição de uma imagem que mostrar para pessoas que por alguma razão não conseguem ver a imagem. Entre outros, textos alternativos auxiliam:

-   Pessoas com baixa visão ou cegas;
-   Pessoas que desabilitaram imagem para economizar dados;
-   Motores de busca (ex: Google, Bing).

O primeiro grupo — pessoa com baixa visa ou cegas — são o grupo de mais se beneficia com os textos alternativos. Eles utilizam algo chamado leitores de tela para navegar na web.

Um leitor de tela transforma uma informação visual em fala ou braile. Para fazer isso com precisão, as imagens do seu site precisam ter textos alternativos.
...
Bem francamente, você pode inserir a informação necessária. Você também pode obter as informações necessárias da imagem, e é isso que estamos tentando alcançar para usuários com leitores de tela também. **_Dê as informações necessárias no texto alternativo, mas torne-o o mais curto e conciso possível._**
...
Muitas interfaces têm um campo para adicionar textos no title a imagens próximas de onde você pode adicionar um texto alternativo. Ignore o texto no atributo title!

Ninguém os usa — eles não trabalham em telas sensíveis ao toque e na área de trabalho eles exigem que o usuário paira por um tempo sobre uma imagem, o que ninguém faz.
...
Na maioria dos casos você deve usar um texto alternativo para imagens, mas existem algumas exceções onde você deve deixar o atributo alt em branco.

> Nota importante: nunca remova o atributo alt, pois irá quebra o padrão HTML. Mas você é permitido inserir uma string vazia, desta forma: **alt=””.** Faça isso nos seguinte casos.
...
Se o ícone do menu tiver um label, você deve deixar o texto alternativo em branco. Muitas vezes eu encontro botões de menu que são lidos como “Menu Menu”. Quando cheguei no menu de menu hambúrguer. Um pouco confuso, não diria?
...
Embora a Machine Learning e a inteligência artificial melhorem rapidamente e possam descrever algumas imagens com bastante precisão, elas não são suficientemente boas para entender o contexto relevante no momento. Além disso, as máquinas não são suficientemente boas para decidir o que é "conciso", e muitas vezes descreverão muito ou muito pouco da imagem.
