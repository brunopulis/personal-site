...
(function (self) {
  ...
  y('Promise', function (a) {
    ...
    b.prototype.S = function (f) {
      if (f === this) this.D(new TypeError('A Promise cannot resolve to itself'));
      else if (f instanceof b) this.U(f);
      else {
        a: switch (typeof f) {
          case 'object':
            var h = null != f;
    ...
    b.prototype.P = function () {
      ...
      'function' === typeof f
        ...
        : 'function' === typeof h
          ...
          : ((f = x.document.createEvent('CustomEvent')), f.initCustomEvent('unhandledrejection', !1, !0, f));
      f.promise = this;
      f.reason = this.m;
      return k(f);
    };
    b.prototype.O = function () {
      if (null != this.h) {
        for (var f = 0; f < this.h.length; ++f) g.l(this.h[f]);
        this.h = null;
      }
    };
    var g = new c();
    ...
    b.race = function (f) {
      return new b(function (h, k) {
        for (var l = ea(f), m = l.next(); !m.done; m = l.next()) d(m.value).J(h, k);
      });
    };
    b.all = function (f) {
      var h = ea(f),
      ...
      return k.done
        ...
        : new b(function (l, m) {
            ...
            var n = [],
              q = 0;
            do (n.push(void 0), q++, d(k.value).J(p(n.length - 1), m), (k = h.next()));
            while (!k.done);
          });
    };
    return b;
  ...
  function ha(a) {
    for (var b = Array(a), c = 0; c < a; c++) b[c] = D();
    return b;
  }
  function D() {
  ...
  function ja(a, b) {
    ...
    if (
      ...
      (b && (a = I(a, b)),
      this.K && (a = I(a, this.K)),
      this.L && 1 < a.length && (a = I(a, this.L)),
      c || '' === c)
    ) {
      a = a.split(c);
      if (this.filter) {
  ...
  function na(a) {
    for (var b = '', c = '', d = 0, e = a.length, g = void 0; d < e; d++) (g = a[d]) !== c && (b += c = g);
    return b;
  }
          ...
          for (var A = 0, w, z; A < u; A++)
            if (((z = r[A]), B)) {
              ...
              d &&
                ((w = (f[z] || 0) + 1),
                (f[z] = w),
                w < e && ((w = d[w - 2] || (d[w - 2] = [])), (w[w.length] = z)));
            } else p[z] = 1;
      }
      if (d) B || (f = p);
      else if (!n) return [];
    ...
    if (d)
      for (a = d.length - 1; 0 <= a; a--)
        for (e = d[a], f = e.length, k = 0; k < f; k++)
          if (((l = e[k]), !B[l])) {
            if (c) c--;
            else if (((g[h++] = l), h === b)) return g;
            B[l] = 1;
          }
    return g;
  }
  function ta(a, b) {
    for (var c = D(), d = D(), e = [], g = 0; g < a.length; g++) c[a[g]] = 1;
    for (a = 0; a < b.length; a++) {
      g = b[a];
      for (var f = 0, h; f < g.length; f++) ((h = g[f]), c[h] && !d[h] && ((d[h] = 1), (e[e.length] = h)));
    }
    return e;
  }
  function M(a) {
  ...
  var va = {
    memory: {charset: 'latin:extra', F: 3, C: 4, s: !1},
    performance: {F: 3, C: 3, B: !1, context: {depth: 2, F: 1}},
    match: {charset: 'latin:extra', H: 'reverse'},
    score: {charset: 'latin:advanced', F: 20, C: 3, context: {depth: 3, F: 9}},
    default: {}
  };
  ...
  function N(a, b) {
    ...
    var c;
    if (a) {
      E(a) ? (a = va[a]) : (c = a.preset) && (a = Object.assign({}, c[c], a));
      c = a.charset;
      var d = a.lang;
        ...
        for (var e = D(), g = D(), f = this.depth, h = this.F, k = 0; k < d; k++) {
          ...
          if (l && m >= this.C && (f || !g[l])) {
            ...
            switch (this.H) {
              ...
              case 'forward':
                if (1 < m) {
                  for (q = 0; q < m; q++) ((n += l[q]), n.length >= this.C && P(this, g, n, p, a, c));
                  break;
                }
              default:
                if (
                  (this.o && (p = Math.min((p / this.o(b, l, k)) | 0, h - 1)),
                  P(this, g, l, p, a, c),
                  f && 1 < d && k < d - 1)
                )
  ...
  function P(a, b, c, d, e, g, f) {
    ...
    if (!b[c] || (f && !b[c][f]))
      (a.B && (h = h[d]),
        f ? ((b = b[c] || (b[c] = D())), (b[f] = 1), (h = h[f] || (h[f] = D()))) : (b[c] = 1),
        (h = h[c] || (h[c] = [])),
        a.B || (h = h[d] || (h[d] = [])),
        (g && h.includes(e)) ||
          ((h[h.length] = e), a.s && ((a = a.register[e] || (a.register[e] = [])), (a[a.length] = h))));
  }
  t.search = function (a, b, c) {
      ...
      if (1 < h) {
        ...
        for (var k = [], l = 0, m = 0, p; l < h; l++)
          if ((p = a[l]) && p.length >= this.C && !c[p])
            if (this.B || f || this.map[p]) ((k[m++] = p), (c[p] = 1));
            else return d;
        a = k;
        h = a.length;
      }
    ...
    for (; c < h; c++) {
      l = a[c];
      g
        ? ((k = xa(this, d, f, b, e, 2 === h, l, n)), (f && !1 === k && d.length) || (n = l))
        : (k = xa(this, d, f, b, e, 1 === h, l));
      if (k) return k;
      if (f && c === h - 1) {
        k = d.length;
        if (!k) {
    ...
    if (l) {
      for (var m = 0, p = Math.min(l.length, h ? a.m : a.F), n = 0, q = 0, r, u; n < p; n++)
        if ((r = l[n]))
          if (
            (a.B && (r = za(r, f, h, a.l)),
            e && r && g && ((u = r.length), u <= e ? ((e -= u), (r = null)) : ((r = r.slice(e)), (e = 0))),
            r && ((k[m++] = r), g && ((q += r.length), q >= d)))
          )
            break;
      if (m) {
        if (g) return ya(k, d, 0);
        b[b.length] = k;
        return;
      }
    }
  ...
  t.remove = function (a, b) {
    ...
    if (c) {
      if (this.s) for (var d = 0, e; d < c.length; d++) ((e = c[d]), e.splice(e.indexOf(a), 1));
      else (Q(this.map, a, this.F, this.B), this.depth && Q(this.h, a, this.m, this.B));
  ...
  function Q(a, b, c, d, e) {
    ...
    if (a.constructor === Array)
      if (e) ((b = a.indexOf(b)), -1 !== b ? 1 < a.length && (a.splice(b, 1), g++) : g++);
      else {
        e = Math.min(a.length, c);
        for (var f = 0, h; f < e; f++) if ((h = a[f])) ((g = Q(h, b, c, d, e)), d || g || delete a[f]);
      }
    else for (f in a) (g = Q(a[f], b, c, d, e)) || delete a[f];
    return g;
  }
  t.searchCache = ua;
  t.export = function (a, b, c, d, e, g) {
    ...
    switch (e || (e = 0)) {
      case 0:
        ...
        if (this.s) {
          var k = D();
          for (var l in this.register) k[l] = 1;
  ...
  function R(a) {
    ...
    var c = 'undefined' === typeof window && self.exports,
      d = this;
  ...
  function Ca(a, b, c) {
    try {
      var d = b
        ...
        : a
          ? new Worker(
              URL.createObjectURL(new Blob(['onmessage=' + Aa.toString()], {type: 'text/javascript'}))
            )
          : new Worker(E(c) ? c : 'worker/worker.js', {type: 'module'});
    } catch (e) {}
    return d;
  }
  function T(a) {
    ...
    for (var e = 0, g, f = void 0; e < d.length; e++)
      ((g = d[e]),
        E(g) || ((f = g), (g = g.field)),
        (f = F(f) ? Object.assign({}, a, f) : a),
        this.A && ((c[g] = new R(f)), c[g].A || (this.A = !1)),
        this.A || (c[g] = new N(f, this.register)),
        (this.I[e] = U(g, this.m)),
        (this.h[e] = g));
    if (this.o) for (a = b.store, E(a) && (a = [a]), b = 0; b < a.length; b++) this.o[b] = U(a[b], this.m);
    this.index = c;
  }
  function U(a, b) {
    for (var c = a.split(':'), d = 0, e = 0; e < c.length; e++)
      ((a = c[e]),
        0 <= a.indexOf('[]') && (a = a.substring(0, a.length - 2)) && (b[d] = !0),
        a && (c[d++] = a));
  ...
  function V(a, b) {
    if (E(b)) a = a[b];
    else for (var c = 0; a && c < b.length; c++) a = a[b[c]];
    return a;
  }
  function W(a, b, c, d, e) {
    ...
    if (d === c.length - 1) b[e] = a;
      ...
      if (a.constructor === Array)
        for (b = b[e] = Array(a.length), e = 0; e < a.length; e++) W(a, b, c, d, e);
      else ((b = b[e] || (b[e] = D())), (e = c[++d]), W(a, b, c, d, e));
  }
  function X(a, b, c, d, e, g, f, h) {
    if ((a = a[f]))
      if (d === b.length - 1) {
        if (a.constructor === Array) {
          if (c[d]) {
            for (b = 0; b < a.length; b++) e.add(g, a[b], !0, !0);
            return;
          }
          a = a.join(' ');
        }
        e.add(g, a, h, !0);
      } else if (a.constructor === Array) for (f = 0; f < a.length; f++) X(a, b, c, d, e, g, f, h);
      else ((f = b[++d]), X(a, b, c, d, e, g, f, h));
  }
  t = T.prototype;
  t.add = function (a, b, c) {
    ...
    if (b && (a || 0 === a)) {
      ...
      if (this.store && (!c || !this.store[a])) {
        if (this.o) {
          var k = D();
          for (c = 0; c < this.o.length; c++) ((d = this.o[c]), E(d) ? (k[d] = b[d]) : W(b, k, d, 0, d[0]));
        }
        this.store[a] = k || b;
      }
    }
  ...
  t.search = function (a, b, c, d) {
      ...
      if (c.constructor === Array) {
        ...
        if (l && (E(l) && (l = [l]), !a)) {
          ...
          for (f = void 0; g < l.length; g++)
            if ((f = Da.call(this, l[g], b, n, m))) ((e[e.length] = f), h++);
          return h ? e : [];
        }
        E(k) && (k = [k]);
      }
    ...
    for (
      var q = !d && (this.A || this.async) && [], r = 0, u = void 0, A = void 0, w = void 0;
      r < k.length;
      r++
    )
      if (
        ((w = void 0),
        (A = k[r]),
        E(A) || ((w = A), (A = w.field), (a = w.query || a), (b = w.limit || b), (m = w.enrich || m)),
        q)
      )
        ...
        if (l && w) {
          ...
          for (H = void 0; Y < l.length; Y++)
            if (((H = l[Y]), (w = (H = this.l[H]) && H.length))) (B++, (z[z.length] = p ? [H] : H));
    ...
    if (b)
      switch ((E(b) && (b = JSON.parse(b)), a)) {
        ...
        case 'reg':
          ...
          this.register = b;
          a = 0;
          for (var c; a < this.h.length; a++) ((c = this.index[this.h[a]]), (c.register = b), (c.s = !1));
          break;
        case 'store':
          this.store = b;
          break;
  ...
  function Pa(a, b) {
    a &&
      ((a = Ia.call(this, a).join(' ')),
      2 < a.length && (a = I(a, Ra)),
      b || (1 < a.length && (a = na(a)), a && (a = a.split(' '))));
    return a || [];
  }
  var Ta = {encode: Sa, G: !1, H: ''},
    Ua = J('(?!\\b)[aeo]');
  function Sa(a) {
    a &&
      ((a = Pa.call(this, a, !0)),
      1 < a.length && (a = a.replace(Ua, '')),
      1 < a.length && (a = na(a)),
      a && (a = a.split(' ')));
    return a || [];
  }
