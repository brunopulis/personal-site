(function () {
          ...
          ${
            ...
            <div class="flex flex-wrap gap-1 mt-2">
              ${item.tags
                ...
                .map(
                  tag =>
                    `<span class="text-xs px-2 py-0.5 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 rounded">#${tag}</span>`
                )
                .join('')}
            </div>
          `
  ...
  function createSearchResultsContainer() {
    ...
    container.className =
      'absolute top-full left-0 right-0 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-b-md shadow-lg z-50 max-h-96 overflow-y-auto hidden';
